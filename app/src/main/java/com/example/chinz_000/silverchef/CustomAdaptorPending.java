...
public class CustomAdaptorPending extends ArrayAdapter {
    private final Context context;
    private final ArrayList<Request> requests;

    public CustomAdaptorPending(Context context, ArrayList<Request> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.rowlayoutpending, parent, false);
